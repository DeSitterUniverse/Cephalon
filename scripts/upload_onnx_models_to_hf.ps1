# LEGACY MIGRATION ARTIFACT — DO NOT RUN.
#
# Cephalon now supports only Jina Nano Retrieval Q8_0 through llama.cpp and
# Jina Reranker v3.5 through its Transformers worker. This retired helper is
# retained as commented history for the old ONNX exports; it is not an active
